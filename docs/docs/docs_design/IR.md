---
id: ir
title: Design of the V11 high-level IR
sidebar_label: High-level IR
---
### Introduction
This document is a reference manual for the V11 High-level IR. The IR is a
...
The V11 high-level IR is optionally typed. Values may be annotated with the
...
In V11, register allocation is performed on the IR. An infinite number of
